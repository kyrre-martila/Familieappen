...
export const menuNavigationItems = [
  ...
  { href: "/health-plans", label: "Helseplan", description: "Dagens hendelser og planer", icon: "health" },
  { href: "/waste-collection", label: "Renovasjon", description: "Neste tømminger", icon: "waste" },
