...
export interface HealthPlan { id: string; familyMemberId: string; name: string; description: string | null; status: HealthPlanStatus; activeLevelId: string | null; activeStepId: string | null; familyMember: FamilyMember; activeLevel?: Pick<HealthPlanLevel, "id" | "levelIndex" | "name"> | null; activeStep?: Pick<HealthPlanStep, "id" | "stepOrder" | "name"> | null; levels?: HealthPlanLevel[]; notificationRecipients?: HealthPlanNotificationRecipient[] }
export interface HealthPlanOccurrence { id: string; healthPlanId: string; scheduledAt: string; originalScheduledAt: string; actionTitle: string; actionInstruction: string | null; status: HealthPlanOccurrenceStatus; completedAt: string | null; occurrenceLevel: Pick<HealthPlanLevel, "levelIndex" | "name"> | null; occurrenceStep: Pick<HealthPlanStep, "stepOrder" | "name"> | null; healthPlan: Pick<HealthPlan, "id" | "name" | "status"> & { familyMember: Pick<FamilyMember, "id" | "displayName"> } }
