import { mergeCreatedReminder, moveReminderBetweenSections, removeReminder, replaceReminder } from "./cache";
...
assert.deepEqual(removeReminder([old, created], "old"), [created], "delete removes the deleted reminder from the cache");
