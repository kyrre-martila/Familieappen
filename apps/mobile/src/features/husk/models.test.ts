...
const base = {
  ...
  title: "Påminnelse",
  icon: "book",
  dueDate: "2026-07-17T14:30:00.000Z",
  date: "2026-07-17",
...
assert.equal(
  mapReminderToViewModel(
    { ...base, date: "2026-07-16", dueDate: "2026-07-16T14:30:00.000Z" },
    localToday,
  ).statusLabel,
  "Forfalt",
);
...
assert.equal(
  isActiveReminder({ archivedAt: "2026-07-17T12:00:00.000Z" }),
  false,
);
assert.deepEqual(
  sortReminders([
    { id: "later", title: "Z", status: "upcoming", date: "2026-07-19" },
    { id: "today", title: "A", status: "today", date: "2026-07-17" },
...
assert.deepEqual(
  ...
  } as any),
  {
    ...
    totalCount: 4,
    progressPercent: 50,
    progressLabel: "2 av 4 fullført",
    audienceLabel: "Hele familien",
  },
);
