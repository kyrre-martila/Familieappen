  ...
  return <>
    <View style={[styles.header, { paddingTop: insets.top + theme.spacing.xs }]}>
      ...
      <View style={styles.actions}>
        ...
        <Pressable accessibilityRole="button" accessibilityLabel="Åpne profilmeny" accessibilityHint="Viser profilvalg og utlogging" onPress={() => openOverlay("profile")} style={({ pressed }) => [styles.actionButton, styles.profileButton, pressed && styles.pressed]}>
