...
const styles = StyleSheet.create({ base: { minHeight: 44, minWidth: 44, alignItems: "center", justifyContent: "center", borderRadius: theme.radius.pill, paddingHorizontal: theme.spacing.lg, paddingVertical: theme.spacing.sm }, primary: { backgroundColor: theme.colors.primary }, secondary: { backgroundColor: theme.colors.primarySoft }, ghost: { backgroundColor: "transparent" }, pressed: { opacity: 0.78 }, disabled: { opacity: 0.48 }, text: { color: theme.colors.surface, fontWeight: "800" }, secondaryText: { color: theme.colors.primaryStrong }, disabledText: { color: theme.colors.textMuted } });
