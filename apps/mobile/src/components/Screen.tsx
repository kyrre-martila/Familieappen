...
export function Screen({ children, scroll = true, style, bottomInset = "screen", topInset = "safe", refreshControl }: { children: ReactNode; scroll?: boolean; style?: ViewStyle; bottomInset?: BottomInset; topInset?: TopInset; refreshControl?: ScrollViewProps["refreshControl"] }) {
  ...
  return scroll ? <ScrollView style={styles.root} contentContainerStyle={contentStyle} refreshControl={refreshControl}>{children}</ScrollView> : <View style={[styles.root, contentStyle]}>{children}</View>;
}
