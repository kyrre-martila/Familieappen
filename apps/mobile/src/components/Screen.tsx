...
export function Screen({ children, scroll = true, style, bottomInset = "screen", refreshControl }: { children: ReactNode; scroll?: boolean; style?: ViewStyle; bottomInset?: BottomInset; refreshControl?: ScrollViewProps["refreshControl"] }) {
