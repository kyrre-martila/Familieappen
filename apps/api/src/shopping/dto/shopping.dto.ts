...
export interface ShoppingListItemDto { id: string; shoppingListId: string; familyCustomShoppingItemId: string | null; label: string; quantity: string | null; unit: string | null; note: string | null; category: string | null; checked: boolean; createdByUserId: string | null; checkedByUserId: string | null; checkedAt: string | null; createdAt: string; updatedAt: string; }
