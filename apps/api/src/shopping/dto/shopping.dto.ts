export interface AddShoppingItemRequestDto { label?: unknown; quantity?: unknown; unit?: unknown; note?: unknown; category?: unknown; createCustom?: unknown; customItemId?: unknown; }
...
export interface ShoppingListCollaboratorDto { id: string; userId: string; name: string | null; email: string; createdAt: string; }
...
export interface ShoppingListSummaryDto { id: string; familyId: string; name: string; isDefault: boolean; ownerUserId: string | null; createdAt: string; updatedAt: string; invitations?: ShoppingListInvitationDto[]; collaborators?: ShoppingListCollaboratorDto[]; }
export interface ShoppingListItemDto { id: string; shoppingListId: string; familyCustomShoppingItemId: string | null; label: string; quantity: string | null; unit: string | null; note: string | null; category: string | null; categorySlug?: string | null; categoryLabel?: string | null; checked: boolean; createdByUserId: string | null; checkedByUserId: string | null; checkedAt: string | null; createdAt: string; updatedAt: string; }
