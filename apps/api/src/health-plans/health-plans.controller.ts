...
export class HealthPlansController {
  ...
  @Post(":id/complete") complete(@Req() req: Request, @Headers("x-family-id") f: string | undefined, @Param("id") id: string) { return this.command(req, f, id, "complete"); }
  ...
  private command(req: Request, familyId: string | undefined, id: string, command: "start" | "pause" | "resume" | "levelUp" | "levelDown" | "complete" | "archive") {
